...
import {Grid, Typography, Paper, Snackbar, Toolbar} from "@material-ui/core";
...
import img from "../images/dukaan.png";
  ...
  return (
    ...
    >
      <Grid
        ...
        alignItems="center"
      >
        <img style={{height: '200px',width:'500px'}}src = {img}/>
        <Typography className={classes.tagline} variant="h4">
          Take Your Community Digital.
        </Typography>
      </Grid>
